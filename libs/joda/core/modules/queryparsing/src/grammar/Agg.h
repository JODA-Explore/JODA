...
//Agg commands
struct aggKeywords : tao::pegtl::sor<
    aggKW_ATTSTAT,
    aggKW_AVG,
    aggKW_COUNT,
    aggKW_SUM,
...
struct aggFrom : tao::pegtl::seq<
    aggKeywords,
    tao::pegtl::pad<tao::pegtl::one<'('>, tao::pegtl::space>,
    tao::pegtl::opt<tao::pegtl::list<functionstateaction, tao::pegtl::one<','>, tao::pegtl::space>,
                    tao::pegtl::pad<tao::pegtl::one<')'>, tao::pegtl::space>>
> {
};
 ...
 * Aggregation Group
 */
struct aggByExpr : tao::pegtl::must<tao::pegtl::pad<functionstateaction, tao::pegtl::space>> {};
struct aggAsIdent : tao::pegtl::identifier {};
struct aggGrouped : tao::pegtl::seq<
    aggKW_GROUP,
    tao::pegtl::pad<aggFrom, tao::pegtl::space>,
...
struct aggSingleExp : tao::pegtl::seq<
    ...
    tao::pegtl::pad<tao::pegtl::sor<aggGrouped, aggFrom>, tao::pegtl::space>,
    tao::pegtl::pad<tao::pegtl::must<tao::pegtl::one<')'>>, tao::pegtl::space>
> {
};
struct aggExp : tao::pegtl::action<aggExpAction, tao::pegtl::list_must<aggSingleExp, tao::pegtl::one<','>, tao::pegtl::space>> {};
