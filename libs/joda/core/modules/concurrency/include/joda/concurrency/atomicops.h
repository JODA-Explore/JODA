...
// have atomic loadVar and storeVar guarantees at the hardware level -- on most
...
#pragma warning(pop)
  ...
  AE_FORCEINLINE T loadVar() const { return value; }
...
class LightweightSemaphore {
 ...
 private:
  ...
  bool waitWithPartialSpinning(std::int64_t timeout_usecs = -1) {
    ...
    if (m_sema.timed_wait(timeout_usecs)) return true;
