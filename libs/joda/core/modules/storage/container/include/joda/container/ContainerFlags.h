...
{
  return (enum ContainerFlag)(JODA_CONTAINER_FLAG_T(selfValue) | JODA_CONTAINER_FLAG_T(inValue));
}
...
struct JODA_CONTAINER_QUEUE {
  JODA_CONTAINER_QUEUE(JODA_CONTAINER_QUEUE& q) = delete; //Delete copy contructor
};
...
struct JODA_CONTAINER_QUEUE<JODA_JSON_CONTAINER_FLAG> {
  ...
  typedef JODA_SHARED_QUEUE<payload_t,(JODA_FLAG_T)JODA_JSON_CONTAINER_FLAG> queue_t;

  static constexpr bool hasFlag(ContainerFlag flag) { return (JODA_JSON_CONTAINER_FLAG) == flag; }
...
struct JODA_CONTAINER_QUEUE<JODA_JSON_CONTAINER_REF_FLAG> {
  ...
  typedef JODA_SHARED_QUEUE<payload_t,(JODA_FLAG_T)JODA_JSON_CONTAINER_REF_FLAG> queue_t;

  static constexpr bool hasFlag(ContainerFlag flag) { return (JODA_JSON_CONTAINER_REF_FLAG) == flag; }

  static constexpr ContainerFlag getFlag() { return JODA_JSON_CONTAINER_REF_FLAG; }
...
typedef JODA_CONTAINER_QUEUE<JODA_JSON_CONTAINER_REF_FLAG> JsonContainerRefQueue;
