...
constexpr enum ParserFlag operator|(const enum ParserFlag selfValue,
  ...
  return (enum ParserFlag)(JODA_PARSER_FLAG_T(selfValue) |
                           JODA_PARSER_FLAG_T(inValue));
}
...
#define JODA_JSON_TEXT_PARSER_FLAG \
  (ParserFlag::JSON | ParserFlag::TEXT | ParserFlag::MEMORY)
#define JODA_JSON_TEXT_STREAM_PARSER_FLAG \
  (ParserFlag::JSON | ParserFlag::TEXT | ParserFlag::STREAM)
...
struct JODA_PARSER_QUEUE<JODA_JSON_TEXT_PARSER_FLAG> {
  ...
  typedef JODA_SHARED_QUEUE<payload_t, (JODA_FLAG_T)JODA_JSON_TEXT_PARSER_FLAG,
                            LargeQueueBlocks>
      queue_t;

  static constexpr bool hasFlag(ParserFlag flag) {
    return (JODA_JSON_TEXT_PARSER_FLAG) == flag;
  }
...
struct JODA_PARSER_QUEUE<JODA_JSON_TEXT_STREAM_PARSER_FLAG> {
  typedef std::pair<std::unique_ptr<IDPositionOrigin>,
                    std::unique_ptr<std::basic_istream<char>>>
      payload_t;
  typedef JODA_SHARED_QUEUE<payload_t,
                            (JODA_FLAG_T)JODA_JSON_TEXT_STREAM_PARSER_FLAG,
                            LargeQueueBlocks>
      queue_t;

  static constexpr bool hasFlag(ParserFlag flag) {
    return (JODA_JSON_TEXT_STREAM_PARSER_FLAG) == flag;
  }

  static constexpr ParserFlag getFlag() {
    return JODA_JSON_TEXT_STREAM_PARSER_FLAG;
  }
...
typedef JODA_PARSER_QUEUE<JODA_JSON_TEXT_STREAM_PARSER_FLAG>
