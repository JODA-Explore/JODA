#ifndef JODA_PIPELINE_LSFILEMapper_H
#define JODA_PIPELINE_LSFILEMapper_H
...
class LSFileMapperExec {
 public:
  ...
  static constexpr size_t OutBulk = 246; 
...
typedef IOExecutor<LSFileMapperExec, tasks::AsyncType::SingleThreaded>
    LSFileMapper;
...
JODA_REGISTER_PIPELINE_TASK_IN_NS(LSFileMapper, "LSFileMapper",
                                  joda::queryexecution::pipeline::tasks::load)


#endif  // JODA_PIPELINE_LSFILEMapper_H