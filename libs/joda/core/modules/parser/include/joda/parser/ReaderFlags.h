...
constexpr enum ReaderFlag operator|(const enum ReaderFlag selfValue,
  ...
  return (enum ReaderFlag)(JODA_READER_FLAG_T(selfValue) |
                           JODA_READER_FLAG_T(inValue));
}
...
#define JODA_JSON_FILE_LINESEPERATED_READER_FLAG \
  (ReaderFlag::JSON | ReaderFlag::FILE | ReaderFlag::LINESEPERATED)
...
struct JODA_READER_QUEUE<JODA_JSON_FILE_LINESEPERATED_READER_FLAG> {
  ...
  typedef JODA_SHARED_QUEUE<
      payload_t, (JODA_FLAG_T)JODA_JSON_FILE_LINESEPERATED_READER_FLAG>
      queue_t;

  static constexpr bool hasFlag(ReaderFlag flag) {
    return (JODA_JSON_FILE_LINESEPERATED_READER_FLAG) == flag;
  }

  static constexpr ReaderFlag getFlag() {
    return JODA_JSON_FILE_LINESEPERATED_READER_FLAG;
  }
...
struct JODA_READER_QUEUE<JODA_JSON_FILE_BEAUTIFIED_READER_FLAG> {
  ...
  typedef JODA_SHARED_QUEUE<payload_t,
                            (JODA_FLAG_T)JODA_JSON_FILE_BEAUTIFIED_READER_FLAG>
      queue_t;

  static constexpr bool hasFlag(ReaderFlag flag) {
    return (JODA_JSON_FILE_BEAUTIFIED_READER_FLAG) == flag;
  }
  static constexpr ReaderFlag getFlag() {
    return JODA_JSON_FILE_BEAUTIFIED_READER_FLAG;
  }
...
struct JODA_READER_QUEUE<JODA_JSON_URL_READER_FLAG> {
  ...
  typedef JODA_SHARED_QUEUE<payload_t, (JODA_FLAG_T)JODA_JSON_URL_READER_FLAG>
      queue_t;

  static constexpr bool hasFlag(ReaderFlag flag) {
    return (JODA_JSON_URL_READER_FLAG) == flag;
  }
 ...
 * Used Reader Queues
 */
typedef JODA_READER_QUEUE<JODA_JSON_FILE_LINESEPERATED_READER_FLAG>
