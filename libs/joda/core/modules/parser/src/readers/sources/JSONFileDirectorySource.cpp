...
joda::docparsing::JSONFileDirectorySource::JSONFileDirectorySource(const std::string &dirPath, const double sample) : joda::docparsing::JSONFileDirectorySource(dirPath,
                                                                                                                                                                false, sample) {}
...
const std::string joda::docparsing::JSONFileDirectorySource::toString() {
  return "Directory: " + dirPath + "; Separated: " + std::to_string(lineSeparated) + "; Sample: "
...
joda::docparsing::JSONFileDirectorySource::JSONFileDirectorySource(const std::string &dirPath, bool lineSeparated, const double sample)
    : lineSeparated(lineSeparated), dirPath(dirPath), sample(sample),
                                                                                                   IImportSource(
                                                                                                       lineSeparated
