...
joda::docparsing::JSONURLSource::JSONURLSource(const std::string &urlPath) : urlPath(urlPath),
                                                                             joda::docparsing::IImportSource(
...
void joda::docparsing::JSONURLSource::feedSources(JsonURLReaderQueue::queue_t &queue, JsonURLReaderQueue::queue_t::ptok_t &ptok) {
