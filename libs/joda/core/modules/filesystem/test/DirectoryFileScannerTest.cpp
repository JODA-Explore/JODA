...
TEST_F(DirectoryFileScannerTest, GetAllFilesInDir) {
  ...
  ASSERT_TRUE(std::find(files.begin(), files.end(), dir + "/formattest.json") !=
              files.end());
  ASSERT_TRUE(std::find(files.begin(), files.end(), dir + "/numtest.json") !=
              files.end());
  ASSERT_TRUE(std::find(files.begin(), files.end(), dir + "/viewtest.json") !=
              files.end());
}
...
TEST_F(DirectoryFileScannerTest, GetFilteredFilesInDir) {
  ...
  ASSERT_TRUE(std::find(files.begin(), files.end(), dirTestDir + "/a.json") !=
              files.end());
  ASSERT_TRUE(std::find(files.begin(), files.end(), dirTestDir + "/b.xml") !=
              files.end());
  ASSERT_TRUE(std::find(files.begin(), files.end(), dirTestDir + "/c.txt") !=
              files.end());
