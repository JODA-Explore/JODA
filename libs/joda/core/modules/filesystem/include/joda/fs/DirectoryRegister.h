...
/**
 * An exception signaling that a directory is already registered in the given
 * register
 */
...
class DirectoryRegister {
 public:
   ...
   * @param checkDuplicate If true, the function fails if the chosen directory
   * was already created
   * @return False if a duplicate was found and checkDuplicate is True or
   * another error occurs; True else
   */
   ...
   * @return True if the directory was successfully deleted; False if an error
   * occured
   */
