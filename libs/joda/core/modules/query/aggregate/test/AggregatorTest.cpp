...
protected:
  ...
  ::testing::AssertionResult testArrayAgg(const std::vector<RapidJsonDocument> &docs, RJMemoryPoolAlloc &alloc, std::vector<std::unique_ptr<joda::query::IValueProvider>> &vals, std::unique_ptr<joda::query::IAggregator> &agg)
  {
    ...
    {
      return ::testing::AssertionFailure() << " arrays do not have the same size";
    }
    for (const auto &val : vals)
    {
      ...
      if (!contains)
      {
        return ::testing::AssertionFailure() << rjvalToString(v) << " not in array " << rjvalToString(aggVal);
      }
    }
...
TEST_F(AggregatorTest, AttributeStatAggregatorSingle)
{
  ...
  testAgg(docs,
          alloc,
          R"({"Count_Total":6,"Count_Object":1,"Count_Array":1,"Count_Null":1,"Count_Boolean":1,"Count_True":1,"Count_False":0,"Count_String":1,"Count_Int":1,"Min_Int":1,"Max_Int":1,"Count_Float":0,"Count_Number":1,"Children":[{"Key":"str","Count_Total":1,"Count_Object":0,"Count_Array":0,"Count_Null":0,"Count_Boolean":0,"Count_True":0,"Count_False":0,"Count_String":1,"Count_Int":0,"Count_Float":0,"Count_Number":0}],"Array_Items":[{"Key":"0","Count_Total":1,"Count_Object":0,"Count_Array":0,"Count_Null":0,"Count_Boolean":0,"Count_True":0,"Count_False":0,"Count_String":0,"Count_Int":1,"Min_Int":1,"Max_Int":1,"Count_Float":0,"Count_Number":1}]})",
          agg);
...
TEST_F(AggregatorTest, AttributeStatAggregatorMerge)
{
  ...
  testAgg({},
          alloc,
          R"({"Count_Total":8,"Count_Object":2,"Count_Array":1,"Count_Null":2,"Count_Boolean":1,"Count_True":1,"Count_False":0,"Count_String":1,"Count_Int":1,"Min_Int":1,"Max_Int":1,"Count_Float":0,"Count_Number":1,"Children":[{"Key":"str","Count_Total":1,"Count_Object":0,"Count_Array":0,"Count_Null":0,"Count_Boolean":0,"Count_True":0,"Count_False":0,"Count_String":1,"Count_Int":0,"Count_Float":0,"Count_Number":0},{"Key":"num","Count_Total":1,"Count_Object":0,"Count_Array":0,"Count_Null":0,"Count_Boolean":0,"Count_True":0,"Count_False":0,"Count_String":0,"Count_Int":1,"Min_Int":1,"Max_Int":1,"Count_Float":0,"Count_Number":1}],"Array_Items":[{"Key":"0","Count_Total":1,"Count_Object":0,"Count_Array":0,"Count_Null":0,"Count_Boolean":0,"Count_True":0,"Count_False":0,"Count_String":0,"Count_Int":1,"Min_Int":1,"Max_Int":1,"Count_Float":0,"Count_Number":1}]})",
          agg);
}