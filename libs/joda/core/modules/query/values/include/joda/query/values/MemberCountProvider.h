...
template
class UnaryPointerAcceptProvider<joda::query::providers::membercount::MemberCountCalculator>;

typedef UnaryPointerAcceptProvider<joda::query::providers::membercount::MemberCountCalculator> MemberCountProvider;
}
