...
void joda::query::ValToPredicate::accept(
...
std::unique_ptr<joda::query::ValToPredicate>
joda::query::ValToPredicate::duplicate() const {
  return std::make_unique<joda::query::ValToPredicate>(val->duplicate());
}
...
joda::query::ValToPredicate::duplicateIVal() const {
