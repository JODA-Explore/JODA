...
/**
 * Visitor analyzing a predicate tree for sub-trees with constant/static results.
 * If such a subtree is found, it is replaced by the constant result in a copied instance.
 */
