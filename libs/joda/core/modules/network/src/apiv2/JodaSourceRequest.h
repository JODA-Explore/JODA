...
/**
* JodaSourceRequest is responsible for handling the retrieval of a list of collections over the API
*/
class JodaSourceRequest {
 ...
 private:
  ...
  static void sendTemporaries(const httplib::Request &req, httplib::Response &res);
  static std::string storageToJSON(const JSONStorage &storage, unsigned long id = 0);
