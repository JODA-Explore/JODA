...
void joda::network::apiv2::JodaResultRequest::registerEndpoint(const std::string &prefix, httplib::Server &server) {
...
void joda::network::apiv2::JodaResultRequest::result(const httplib::Request &req, httplib::Response &res) {
  auto id_ = req.params.find("id");
  if (id_ == req.params.end()) throw (JodaMissingParameterException("id"));
...
void joda::network::apiv2::JodaResultRequest::sendResult(httplib::Response &res,
