...
/**
 * This class retrieves information about the host system and programs memory
 * consumption.
 */
class MemoryUtility {
 public:
   ...
   * It stores the size in byte form, but is able to convert into all
   * representations.
   */
  class MemorySize {
   public:
    ...
    /**
     * Converts a memory size that is stored in a different power of ten to
     * bytes.
     * @param xbytes the number of <powerOfThousand>bytes to convert
     * @param powerOfThousand The power of thousand of the input
     * @return The number of bytes.
     */
    static MemoryT convertToBytes(const MemoryT xbytes,
                                  const int powerOfThousand = SIZE::B);

    /**
     * Converts a memory size that is stored in a different power of ten (SI) to
     * bytes.
     * @param xbytes the number of <powerOfThousand>bytes (SI) to convert
     * @param powerOfThousand The power of thousand of the input
     * @return The number of bytes.
     */
    static MemoryT convertToBytesSI(const MemoryT xbytes,
                                    const int powerOfThousand = SIZE::B);
    ...
    /**
     * Returns the number of Xbytes of the memory representation with the given
     * base
  ...
  /**
   * Helper function to translate a percentage in [0,1] to human readable format
   * in "[0,100]%"
